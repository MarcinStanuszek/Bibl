...
namespace Biblioteka.Controllers
{
    public class BookModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Autor")] BookModel bookModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Autor")] BookModel bookModel)
        {
